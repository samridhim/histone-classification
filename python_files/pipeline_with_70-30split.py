def pipe(f1,f2):
    ...
    file1_70= "inter_bed/"+filename1+"_70percent.bed"
    file1_30= "inter_bed/"+filename1+"_30percent.bed"
    file2_70= "inter_bed/"+filename2+"_70percent.bed"
    file2_30="inter_bed/"+filename2+"_30percent.bed"

    intermediate_file1= "inter_bed/"+filename1+"_minus_"+filename2+".bed"
    intermediate_file2= "inter_bed/"+filename2+"_minus_"+filename1+".bed"

    file1_70_fasta = "inter_fa/"+filename1+"_70"+ ".fa"
    file2_70_fasta = "inter_fa/"+filename2+"_70"+".fa"
    file1_30_fasta = "inter_fa/"+filename1+"_30"+".fa"
    file2_30_fasta = "inter_fa/"+filename2+"_30"+".fa"
